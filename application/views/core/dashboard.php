        ...
        <div aria-hidden="true" class="onboarding-modal modal fade animated" role="dialog" data-backdrop="static" data-keyboard="false" tabindex="-1">
            <div class="modal-dialog modal-lg modal-centered" role="document">
                <div class="modal-content text-center"><button aria-label="Close" class="close" data-dismiss="modal"
                    ...
                    <?=form_open('programmes/create','id="prog_c_f"')?>
                    <div class="onboarding-slider-w">
                        <div class="onboarding-slide">
                            <div class="onboarding-content with-gradient text-center">
                                <h4 class="onboarding-title">Create New ICP Programme</h4>
                                <div class="onboarding-text">Please fill the following informations to create new ICP
                                    Programme.</div>
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="prog_name"
                                                            placeholder="Enter ICP Programme Title/Name.." type="text">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group"><label for=""> Programme Description</label>
                                                        <textarea rows="5" name="prog_desc" class="form-control"
                                                            placeholder="Enter Programme Description.."></textarea>
                                                    ...
                                                    <div class="form-group"><label for=""> Procurement Value</label>
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control" name="proc_value"
                                                                placeholder="Enter Procurement Value.." type="text">
                                            ...
                                            <div class="row text-left">
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control start_date" name="prog_start_date"
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control end_date" name="prog_end_date"
                                                            readonly placeholder="Enter ICP Programme Title/Name.."
                                                            type="text">
                                ...
                                <div class="element-wrapper">
                                    <div class="element-actions">
                                        <form class="form-inline justify-content-sm-end btn-block">
                                            <a class="btn btn-primary" data-target=".onboarding-modal" data-toggle="modal" href="#"><i class="os-icon os-icon-plus-circle"></i><span>New Programme</span></a>
                                                    ...
                                                    <div class="post-content">
                                                                ...
                                                                <div class="os-progress-bar danger">
                                                                    <div class="bar-labels">
                                                                        <div class="bar-label-left"><span
                                                                                class="font-p9">Progress</span></div>
                                                        ...
                                                        <div class="post-foot b-t pt-2">
                                                            ...
                                                            <a class="btn btn-primary"
                                                                href="<?=site_url('programmes/tda-prog-'.$acronym.'-'.str_pad($programme->proc_sector_id, 2, "0", STR_PAD_LEFT).'-'.$programme->prog_id.'-'.date('Y', strtotime($programme->created_at)))?>"><span>Details</span><i
