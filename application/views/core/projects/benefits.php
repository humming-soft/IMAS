                                    ...
                                    <div class="element-content">
                                        <div class="element-box">
                                            <div class="table-responsive">
                                                ...
                                                <div class="text-right"><button data-toggle="modal" class="btn btn-primary" id="addrow5" style="height: 30px"><i class="os-icon os-icon-plus-circle"></i> Add New</button></div>
