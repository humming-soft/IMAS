                ...
                <div class="content-i">
                            ...
                            <div class="col-sm-12">
                                <div class="element-wrapper">
                                    <div class="element-actions">
                                        <form class="form-inline justify-content-sm-end"><select class="form-control form-control-sm rounded">
                                    ...
                                    <div class="element-content">
                                        <div class="row">
                                            ...
                                            <div class="d-none d-xxxl-block col-xxxl-3"><a class="element-box el-tablo"
                                                    href="#">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 d-xxxl-none">
                                ...
                                <div class="element-wrapper">
                                    ...
                                    <div class="element-box">
                                        <div class="el-chart-w"><canvas height="120" id="donutChart" width="120"></canvas>
                                    ...
                                    <div class="element-box">
                                        ...
                                        <div class="mt-4 border-top pt-3">
                                            <div class="element-actions d-none d-sm-block">
                                                <form class="form-inline justify-content-sm-end"><select class="form-control form-control-sm form-control-faded">
                                            ...
                                            <div class="el-chart-w"><canvas data-chart-data="13,28,19,24,43,49,40,35,42,46,38,32,45"
                                            ...
                                            <table class="table table-bordered table-lg table-v2 table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="row-actions"><a href="#"><i class="os-icon os-icon-ui-49"></i></a><a
                                                                href="#"><i class="os-icon os-icon-grid-10"></i></a><a
                                                                class="danger" href="#"><i class="os-icon os-icon-ui-15"></i></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center"><input class="form-control" type="checkbox"></td>
                                                        <td>Mike Astone</td>
                    ...
                    <div class="content-panel">
                        ...
                        <div class="element-wrapper">
                            ...
                            <div class="element-box-tp">
                                <div class="el-buttons-list full-width"><a class="btn btn-white btn-sm" href="#"><i
                                        ...
                                        class="btn btn-white btn-sm" href="#"><i class="os-icon os-icon-window-content"></i><span>Customer
                                            Comments</span></a><a class="btn btn-white btn-sm" href="#"><i class="os-icon os-icon-wallet-loaded"></i><span>Store
                                            Settings</span></a></div>
                            </div>
                        </div>
                        <!--------------------
                                ...
                                <div class="activity-boxes-w">
                                    <div class="activity-box-w">
                                        ...
                                        <div class="activity-box">
                                            ...
                                            <div class="activity-info">
                                                <div class="activity-role">John Mayers</div><strong class="activity-title">Opened
                                                    New Account</strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="activity-box-w">
                                        ...
                                        <div class="activity-box">
                                            ...
                                            <div class="activity-info">
                                                <div class="activity-role">Ben Gossman</div><strong class="activity-title">Posted
                                                    Comment</strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="activity-box-w">
                                        ...
                                        <div class="activity-box">
                                            ...
                                            <div class="activity-info">
                                                <div class="activity-role">Phil Nokorin</div><strong class="activity-title">Opened
                                                    New Account</strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="activity-box-w">
                                        ...
                                        <div class="activity-box">
                                            ...
                                            <div class="activity-info">
                                                <div class="activity-role">Jenny Miksa</div><strong class="activity-title">Uploaded
                                                    Image</strong>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="element-wrapper">
                            ...
                            <div class="element-box-tp">
                                <div class="input-search-w"><input class="form-control rounded bright" placeholder="Search team members..."
                                        type="search"></div>
