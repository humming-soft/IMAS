<!DOCTYPE html>
<html>
<!-- Mirrored from light.pinsupreme.com/tables_regular.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Oct 2018 08:42:26 GMT -->
...
-------------------->
            ...
            <div class="content-i">
                <div class="content-box">
                    <div class="element-wrapper"><h6 class="element-header">Tables Examples</h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <form class="form-inline justify-content-sm-end"><input
                                                class="form-control form-control-sm rounded bright" placeholder="Search"
...
--------------------></div>
                    ...
                    <div class="element-wrapper">
                        <div class="element-box-tp"><h5 class="form-header">Table without wrapper</h5>
                            <div class="form-desc">You can put a table tag inside an <code>.element-box-tp</code> class
                                wrapper and add <code>.table</code> class to it to get something like this:
                            </div>
...
--------------------></div>
                    ...
                    <div class="element-wrapper">
                        <div class="element-box"><h5 class="form-header">Table Striped</h5>
                            <div class="form-desc">You can add class <code>.table-striped</code> and <code>.table</code>
...
--------------------></div>
                    ...
                    <div class="element-wrapper">
                        <div class="element-box"><h5 class="form-header">Bordered and Striped Table</h5>
                            <div class="form-desc">You can add class <code>.table-bordered</code>,
                                <code>.table-striped</code> and <code>.table</code> to a table element to get striped
                                table:
                            </div>
                            <div class="table-responsive"><!--------------------
START - Basic Table
...
<!-- Mirrored from light.pinsupreme.com/tables_regular.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Oct 2018 08:42:27 GMT -->
</html>
