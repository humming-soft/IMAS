<ul class="breadcrumb">
    <li class="breadcrumb-item"><a class="text-primary" href="<?= site_url('programmes') ?>"><i
                class="os-icon os-icon-home"></i></a></li>
    <li class="breadcrumb-item"><a class="text-primary"
                                   href="<?= site_url('programmes/' . $this->uri->segment(0)) ?>"><?= $programme[0]->prog_name ?></a>
    </li>
                    ...
                    <div class="element-box">
                        <div class="col-sm-12 text-right">
                            <div class="form-buttons-w">
                                <button class="btn btn-primary" type="submit"><i class="os-icon os-icon-navigation"></i>
                                    Save
                                </button>
                            </div>
                        </div>
                        <div class="row">
                            <?php if (sizeof($icv_project) > 0) {
                                foreach ($icv_project as $icv_project) { ?>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="form-group"><label for="">Total Non MLC</label>
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" readonly id="sumNonMLC" name="sumNonMLC"
                                                       value="<?= $icv_project['p_nonmlc'] ?>" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="form-group"><label for="">Total MLC</label>
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" readonly id="sumMLC" name="sumMLC"
                                                       value="<?= $icv_project['p_mlc'] ?>" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="form-group"><label for="">Total ICV</label>
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" readonly id="totalICV" name="totalICV"
                                                       value="<?= $icv_project['p_total'] ?>" type="text">
                                            </div>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group"><label for="">Total MLC</label>
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" readonly id="sumMLC" name="sumMLC" value="0"
                                                   type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group"><label for="">Total ICV</label>
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" readonly id="totalICV" name="totalICV" value="0"
                                                   type="text">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php foreach ($icv_milestone as $icv_milestone) { ?>
                            ...
                            <?php foreach ($icv_milestone['activities'] as $act) { ?>
                                <div class="aec-full-message-w"
                                     style="margin-left: 10%; margin-bottom: 8px; !important">
                                        ...
                                        <div class="message-head">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        <label for=""> Timeline /Completion Period</label>
                                                        <b class="font d-block"><?= $act['activity_start_date'] ?>
                                                            - <?= $act['activity_end_date'] ?></b>
                                                        <input class="form-control" value="<?= $act['activity_id'] ?> "
                                                               id=milestoneID name=milestoneID[] type="hidden">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <b class="font d-block"><input type="file"
                                                                                       name="files[<?= $act['activity_id'] ?>][]"
                                                                                       multiple value="Upload"></b>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table class="tabIcv">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control nonMLC"
                                                                           value="<?= $act['nonmlc'] ?>" id="nonMLC"
                                                                           name="nonMlC[]" type="text">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <input class="form-control nonMLCMultiplier"
                                                                           value="<?= $act['nonmlcMul'] ?>"
                                                                           id="nonMLCMUL" name="nonMlCMUL[]" readonly
                                                                           type="text" value="">
                                                                    <div class="input-group-append">
                                                                        <div
                                                                            class="input-group-text nonMLCMultiplierChoose">
                                                                            Choose
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <input class="form-control"
                                                                           value="<?= $act['nonmlcMu'] ?>" id="nonMLCMU"
                                                                           name="nonMlCMU[]" readonly type="hidden"
                                                                           value="">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control MLC"
                                                                           value="<?= $act['mlc'] ?>" id="MLC"
                                                                           name="MlC[]" type="text">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <input class="form-control MLCMultiplier"
                                                                           value="<?= $act['mlcMul'] ?>" id="MLCMUL"
                                                                           name="MlCMUL[]" placeholder="Choose" readonly
                                                                           type="text" value="">
                                                                    <div class="input-group-append">
                                                                        <div
                                                                            class="input-group-text MLCMultiplierChoose">
                                                                            Choose
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td hidden>
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <input class="form-control" id="MLCMU"
                                                                           value="<?= $act['mlcMu'] ?>" name="MlCMU[]"
                                                                           readonly type="hidden" value="">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group"><label for="">Item</label><select class="form-control"
                                                                                              id="item1">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    <button class="mr-2 mb-2 btn btn-primary" type="button" data-dismiss="modal">Save
                                    </button>
                                </div>
                            </div>
                        </form>
...
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="multipilerModelNonMLC" role="dialog"
     tabindex="-1">
    <div class="modal-dialog modal-centered" role="document">
        <div class="modal-content text-center">
            <div class="onboarding-slider-w">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group"><label for="">Item</label><select class="form-control"
                                            ...
                                            <?php foreach ($icv_multiplier_nonMLC as $nonmlcM) { ?>
                                                <option
                                                    value="<?= $nonmlcM->mul_id ?>"> <?= $nonmlcM->mul_text ?></option>
                                            <?php } ?>
                                        </select></div>
                                </div>
...
<div aria-hidden="true" class="onboarding-modal modal fade animated" id="multipilerModelMLC" role="dialog"
     tabindex="-1">
    <div class="modal-dialog modal-centered" role="document">
        <div class="modal-content text-center">
            <div class="onboarding-slider-w">
