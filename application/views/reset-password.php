...
<head>
	<title>IMAS(ICP Management System) - Reset Password</title>
	<meta charset="utf-8">
					...
					<div class="col-xl-12 pa-0">
						<div class="auth-form-wrap pt-xl-0 pt-40">
							<div class="auth-form w-xl-30 w-sm-50 w-100">
								<form>
                                    <h1 class="display-5 mb-4 text-center">Please reset your password</h1>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
											<div class="input-group-append">
                                                <span class="input-group-text"><i class="os-icon os-icon-unlock"></i></span>
                                            </div>
                                            <input class="form-control" placeholder="Re-enter new password" type="password">
                                        </div>
                                    </div>
									<button class="btn btn-primary btn-block mb-2" type="submit">Reset Password</button>
									<div class="hs-hr"></div>
